      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            I'd love to hear from you! Whether you want to collaborate, have a coffee in Warsaw, 
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600">hello@mehmetnuri.com</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <h4 className="font-semibold text-gray-900 mb-3">Coffee in Warsaw?</h4>
              <p className="text-gray-600 text-sm">
                If you're in Warsaw or planning to visit, I'd be happy to show you around 
                some of my favorite spots in the city. Let's grab a coffee and explore together!
              </p>
            </div>
          </div>
